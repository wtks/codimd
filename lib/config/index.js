...
if (['filesystem', 's3', 'minio', 'imgur', 'azure', 'swift'].indexOf(config.imageUploadType) === -1) {
  logger.error('"imageuploadtype" is not correctly set. Please use "filesystem", "s3", "minio", "azure", "swift" or "imgur". Defaulting to "filesystem"')
